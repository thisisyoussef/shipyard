...
|---|---|---|---|
| P4-S01 | Graph Runtime and Fallback Contract | Define the LangGraph state shape, nodes, conditional edges, and the equivalent raw-loop fallback path. | Phase 3 implementation, Phase Pre-2 implementation |
